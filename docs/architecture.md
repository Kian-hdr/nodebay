...
The MarkItDown runtime is generated reproducibly but excluded from Git. yt-dlp, FFmpeg, and ImageOptim are separately installed companions. Browser bridge 0.1.0 is first-party GPL-3.0 code bundled as source resources; Chrome still requires explicit unpacked-extension installation.
